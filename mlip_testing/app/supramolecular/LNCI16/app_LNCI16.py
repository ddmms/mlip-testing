...
DATA_PATH = Path(__file__).parent.parent.parent / "data" / "supramolecular" / "LNCI16"

SCATTER = read_plot(
    DATA_PATH / "figure_interaction_energies.json", id=f"{BENCHMARK_NAME}-figure"
)
STRUCTS_DIR = DATA_PATH / list(MODELS.keys())[0]
# Assets dir will be parent directory - individual files for each system (16 systems)
STRUCTS = [
