...
structs = [
    f"assets/{list(MODELS.keys())[0]}/{i}.xyz"
...
def build_layout() -> Div:
    ...
    return Div(
        [
            H1("OC157 benchmark", style={"color": "black"}),
            Div(metrics_table),
            Div(id="figure-placeholder"),
            Div(id="struct-placeholder"),
        ]
    )
...
def register_callbacks(app: Dash) -> None:
    ...
    plot_from_table_column(
        ...
        column_to_plot={"Mean Absolute Error": scatter, "Ranking Error": scatter},
    )
